module Hke
  ...
  @future_messages = FutureMessage.order(:send_date)
            ...
            turbo_stream.update(
              ...
              locals: {
                items: @future_messages,
	                fields: [:send_date, :message_type, :delivery_method, :email, :phone, :token],
                other_fields: [
    ...
    def approve
      ...
      @require_approval = Hke::PreferenceResolver.resolve(preferring: ActsAsTenant.current_tenant).require_message_approval == true
